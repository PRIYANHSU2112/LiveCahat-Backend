...
listenerProfileSchema.index({ kycStatus: 1, _id: -1 });
listenerProfileSchema.index({ kycStatus: 1, createdAt: -1, _id: -1 });
listenerProfileSchema.index({ kycStatus: 1, followersCount: -1, totalSessions: -1, _id: -1 });
