...
export const COIN_REFERENCE_TYPES = ['PURCHASE', 'VIDEO_CALL', 'AUDIO_CALL', 'CHAT', 'GIFT', 'REFUND', 'BONUS', 'PENALTY', 'MATCH', 'SETTLEMENT', 'LIVE_ROOM', 'VISIBILITY_BOOST'];
export const VISIBILITY_BOOST_STATUSES = ['ACTIVE', 'EXPIRED', 'CANCELLED'];
