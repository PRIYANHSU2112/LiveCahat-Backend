...
import client from '../observability/metrics.js';
import { getRecentTracesStore } from '../observability/tracing.js';
...
class MonitoringService {
  ...
  /**
   * Detailed Node.js runtime process, memory, DB, Redis metrics
   */
